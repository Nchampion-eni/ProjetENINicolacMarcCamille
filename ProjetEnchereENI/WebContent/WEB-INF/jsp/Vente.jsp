...
<body>
	<form action="ServletGerantLesVentes" method="post">
		...
		</select> <label for="prix">prix :</label> <input type="number" name="prix">
		...
		<input type="Date" name="dateDebut" value="" /> -->
		 <label for="dateFin">date
			de fin de l'enchère : <span class="requis"></span>
		</label> <input type="Date" name="dateFin" value="" /> <label
